  ...
  const menuItems = ['About', 'Projects', 'Skills', 'Contact'];
    ...
    return (
      <motion.header 
        ...
        className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm text-white shadow-lg w-full overflow-hidden"
      >
        {/* Smog Effect */}
        <motion.div
          ...
          className="absolute bottom-0 left-0 w-screen h-[150%] max-w-screen bg-gradient-to-r from-white/50 via-white/20 to-white/10 blur-2xl"
          style={{ zIndex: 0 }} 
        />
  
        <div className="container mx-auto px-4 py-3 md:py-4 flex justify-between items-center relative z-10 w-full max-w-screen">
          {/* Logo and Brand */}
          <motion.div
